...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.userName = @"Ryan Powers";
        self.matchName = @"Stephanie Lazio";
       ...
       UIImage *avatar_image = [[DataAccess singletonInstance] getProfileImage];
        UIImage *match_image = [UIImage imageNamed:@"blurred"];
    ...
    self.messages = [[NSMutableArray alloc] initWithObjects:
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdCook
                                        senderDisplayName:self.userName
                                                     ...
                                                     text:@"Hey sorry I had to run last night, my friends were leaving. Glad we were able to connect on here!"],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdWoz
                                        senderDisplayName:self.matchName
                                                     date:[NSDate distantPast]
                                                     text:@"No problem haha. I walked away and was like..where'd he go?"],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdCook
                                        senderDisplayName:self.userName
                                                     date:[NSDate distantPast]
                                                     text:@"Ya, my ride was in a hurry. It was nice talking to you though :)"],
                     
                     [[JSQMessage alloc] initWithSenderId:kJSQAvatarIdWoz
                                        senderDisplayName:self.matchName
                                                     date:[NSDate date]
                                                     text:@"Likewise. Let's do coffee sometime, I just added you on facebook"],
