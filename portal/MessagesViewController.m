...
- (void)styleNavBar {
  ...
  //  newNavBar.backgroundColor = [UIColor whiteColor];
    ...
    UIImage *proIcon = [UIImage imageNamed:@"blurred"];
    ...
    nameLabel.text = @"Stephanie Lazio";
    ...
    titleView.titleLabel.font = [UIFont fontWithName:@"Superclarendon-Regular" size:19.0f];
...
- (void)receiveMessagePressed:(UIBarButtonItem *)sender
{
    ...
    NSString *matchName = @"Stephanie Lazio";
